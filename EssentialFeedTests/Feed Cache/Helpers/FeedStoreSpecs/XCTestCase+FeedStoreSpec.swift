...
extension FeedStoreSpec where Self: XCTestCase  {
    ...
    func assertThatRetrieveDeliversEmptyOnEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        expect(sut, toRetrieveWith: .success(.empty))
    }
    ...
    func assertThatRetrieveDeliversFoundValuesOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveWith: .success(.found(feed: feed, timestamp: timestamp)), file: file, line: line)
    }
    ...
    func assertThatInsertOverridesPreviouslyInsertedCacheValues(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveWith: .success(.found(feed: latestFeed, timestamp: latestTimestamp)), file: file, line: line)
    }
    ...
    func assertThatDeleteHasNoSideEffectsOnEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveWith: .success(.empty), file: file, line: line)
    }
...
extension FeedStoreSpec where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieveWith expectedResult: FeedStore.RetrievalResult, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case let (.success(.found(expected)), .success(.found(received))):

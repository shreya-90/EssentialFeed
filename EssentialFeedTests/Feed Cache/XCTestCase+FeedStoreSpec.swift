...
extension FeedStoreSpec where Self: XCTestCase  {
    ...
    func assertThatRetrieveDeliversFoundValuesOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveWith: .found(feed: feed, timestamp: timestamp), file: file, line: line)
    }
    ...
    func assertThatInsertOverridesPreviouslyInsertedCacheValues(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveWith: .found(feed: latestFeed, timestamp: latestTimestamp), file: file, line: line)
    }
